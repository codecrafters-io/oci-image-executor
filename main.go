		...
		Drives: []models.Drive{
			{
				...
				// PathOnHost:   pointy.String("/workspaces/oci-image-executor/bionic.rootfs.ext4"),
				PathOnHost: pointy.String(rootFSPath),
				// Partuuid: "dff363d3-970f-4ea8-abfc-bb713edf9d23",
			},
		},
		KernelImagePath: "/workspaces/oci-image-executor/vmlinux.bin",
		KernelArgs:      "ro console=ttyS0 noapic reboot=k panic=1 pci=off init=/bin/sh",
		LogLevel:        "Debug",
